...
object EvidenceAnalyzer {
    ...
    fun analyze(claim: DamageClaim): String {
        ...
        for (step in 1..Config.ANALYSIS_STEPS) {
            ...
            // Report progress at checkpoints. The server only needs to hear from
            // this Activity often enough to notice a dead Worker in reasonable
            // time — every tenth region, well inside HEARTBEAT_TIMEOUT_SECONDS.
